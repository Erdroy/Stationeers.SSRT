...
public class SSRT : MonoBehaviour 
{
    ...
    public static AssetBundle Bundle => _bundle ?? (_bundle = BundleManager.GetAssetBundle("gtaogishaders"));
	...
	void Awake()
	{
        ...
        Debug.Log(Bundle.LoadAsset<Shader>("SSRT"));
		ssrtMaterial = new Material(Bundle.LoadAsset<Shader>("SSRT"));
